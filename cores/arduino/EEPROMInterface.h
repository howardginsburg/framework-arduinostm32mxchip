...
public:
    ...
    */
    ...
    /**
    * @brief    Save Wi-Fi setting to secure chip.
    *
    * @param    ssid                The SSID of the Wi-Fi hotspot.
    *           pwd                 The password of the Wi-Fi hotspot.
    *
    * @return   Return 0 on success, otherwise return -1.
    */
    int saveWiFiSetting(char *ssid, char *pwd);
    ...
    *
    * @param    x509Cert            The X.509 certificate to be saved.
    *
    * @return   Return 0 on success, otherwise return -1.
    */
    ...
    * @return   Return 0 on success, otherwise return -1.
    */
    int readWiFiSetting(char *ssid, int ssidSize, char *pwd, int pwdSize);

    /**
    * @brief    Retrieve device connection string from secure chip.
    *
    * @param    deviceConnString    The buffer to retrieve device connection string.
    *           buffSize            The buffer size of deviceConnString.
    *
    * @return   Return 0 on success, otherwise return -1.
    */
    int readDeviceConnectionString(char *deviceConnString, int buffSize);

    /**
    * @brief    Retrieve X.509 certificate from secure chip.
    *
    * @param    x509Cert            The buffer to retrieve X.509 certificate.
    *           buffSize            The buffer size of X.509 certificate.
    *
    * @return   Return 0 on success, otherwise return -1.
    */
